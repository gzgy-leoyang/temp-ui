...
Rectangle {
    ...
    property int vkcWidth:      1024    //键盘宽度
    property int vkcWidth_mini: 400     //mini数字键盘宽度
    property int vkcHeight:     280     //键盘高度
    ...
    Column {
        ...
        Row {
           ...
           VkButton { width: vk.width/10.24;img_source:"../../../images/VirtualKeyboard/backspace.png";op: "dle";Component.onCompleted:clicked.connect(buttonPressed)}
        }
        Row {
            x: vk.width/20
            spacing: vk.width/100
           ...
           VkButton {width: vk.width/10.24;op: "Back";img_source: "../../../images/VirtualKeyboard/delete.png"; Component.onCompleted:clicked.connect(buttonPressed)}
        }
        Row {
            x: vk.width/100
            spacing: vk.width/100
            VkButton {
                fontSize: 50*0.3;
                width: vk.width/12.8
                img_source:"../../../images/VirtualKeyboard/CaseSw.png";
                onClicked: {
                    if(capsLock === true)
                    {
                        capsLock = false
        ...
        Row {
           ...
           VkButton {fontSize: vk.width/30;text: "@"; op: text; Component.onCompleted: clicked.connect(buttonPressed) }
           VkButton {width: vk.width/1.83;op: " ";Component.onCompleted:clicked.connect(buttonPressed)}
           VkButton {width: vk.width/14.63;text: "-";op: text;Component.onCompleted:clicked.connect(buttonPressed)}
           VkButton {width: vk.width/7.88;img_source:"../../../images/VirtualKeyboard/enter.png";op: "Enter";Component.onCompleted:clicked.connect(buttonPressed)}
        }
    }
    ...
    Column {
        ...
        Row {
            x: vk.width/100
            spacing: vk.width/100
           VkButton { text: "1"; op: "1"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "2"; op: "2"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "3"; op: "3"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "4"; op: "4"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "5"; op: "5"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "6"; op: "6"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "7"; op: "7"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "8"; op: "8"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "9"; op: "9"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton { text: "0"; op: "0"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {width: vk.width/10.24;img_source:"../../../images/VirtualKeyboard/backspace.png";op: "dle"; Component.onCompleted: clicked.connect(buttonPressed)}
        }
        Row {
            x: vk.width/20
            spacing: vk.width/100
           VkButton {fontSize: vk.width/30;text: "#"; op: "#"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width/30;text: "$"; op: "$"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width/30;text: "%"; op: "%"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width/30;text: "&"; op: "&"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width/30;text: "*"; op: "*"; Component.onCompleted: clicked.connect(buttonPressed)}
           ...
           VkButton {
                ...
                op: "Back"
                img_source: "../../../images/VirtualKeyboard/delete.png"
                Component.onCompleted:
                    clicked.connect(buttonPressed)
            }
        }
        Row {
           ...
           VkButton {fontSize: vk.width*0.03;text: "<"; op: "<"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width*0.03;text: ">"; op: ">"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width*0.03;text: "="; op: "="; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width*0.03;text: ":"; op: ":"; Component.onCompleted: clicked.connect(buttonPressed)}
           VkButton {fontSize: vk.width*0.03;text: "!"; op: "!"; Component.onCompleted: clicked.connect(buttonPressed)}
    ...
    Column {
        ...
        Row {
            ...
            VkButton {
                width: vk.width*0.19
                img_source:"../../../images/VirtualKeyboard/moveKey.png";
                MouseArea {
           ...
           VkButton {width: vk.width*0.19;img_source:"../../../images/VirtualKeyboard/backspace.png"; op: "dle";Component.onCompleted:clicked.connect(buttonPressed)}
        }
        ...
        Row {
           ...
           VkButton {width: vk.width*0.19;img_source:"../../../images/VirtualKeyboard/delete.png";op: "Back";Component.onCompleted:clicked.connect(buttonPressed)}
        }
        ...
        Row {
           ...
           VkButton {width: vk.width*0.16;img_source:"../../../images/VirtualKeyboard/space.png";op: " ";Component.onCompleted:clicked.connect(buttonPressed)}
           VkButton {width: vk.width*0.21;img_source:"../../../images/VirtualKeyboard/enter.png";op: "Enter";Component.onCompleted:clicked.connect(buttonPressed)}
        }
    }
